...
export function DottedMap<M extends Marker = Marker>({
  ...
  // piri's `addMarkers` constrains its generic to an internal Marker type
  // with an index signature that our public `Marker` doesn't (and shouldn't) have.
  const processedMarkers = (
    addMarkers as unknown as (m: M[]) => MapMarker<M>[]
  )(markers);
